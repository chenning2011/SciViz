...
Only one argument is necessary, `data`, a matrix or a data frame. The data must be numeric, with all categorical variables dummy coded, in order for correlation values to be calculated. 
